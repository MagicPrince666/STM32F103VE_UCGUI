...
typedef struct
{
	...
	u16 x[5]; 		//当前坐标
	u16 y[5];		//电容屏有最多5组坐标,电阻屏则用x[0],y[0]代表:此次扫描时,触屏的坐标,用
								//x[4],y[4]存储第一次按下时的坐标. 
	u8  sta;					//笔的状态 
								//b7:按下1/松开0; 
	                            //b6:0,没有按键按下;1,有按键按下. 
...
//电阻屏芯片连接引脚	   
#define PEN  		PAin(8)  	//PF10 INT
#define DOUT 		PBin(14)   	//PF8  MISO
#define TDIN 		PBout(15)  	//PF9  MOSI
#define TCLK 		PBout(13)  	//PB1  SCLK
#define TCS  		PBout(12)  	//PB2  CS  
